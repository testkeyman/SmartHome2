...
public class CRC16 {
	...
	public static String getCrc(String tem) {
		...
		return CRC16.getBufHexStr(sbuf).substring(12, 16).toUpperCase();
	}
	...
	public static byte[] int2byte(int i){
		...
		byte[]by=new byte[2];
		by[0]=Byte.decode("0x"+str.charAt(0)+str.charAt(1)).byteValue();
		by[1]=Byte.decode("0x"+str.charAt(2)+str.charAt(3)).byteValue();
		return by;
	}
